  ...
  template: `
    <div class="min-h-screen flex flex-col items-center justify-center p-6 bg-stone-50 dark:bg-stone-950">
      <div class="w-full max-w-sm">
        ...
        <p class="text-center text-stone-600 dark:text-stone-400 mb-8">Create your account</p>
        ...
        <p class="mt-6 text-center text-stone-600 dark:text-stone-400">
          Already have an account? <a routerLink="/login" class="text-primary-600 dark:text-primary-400 font-medium">Sign in</a>
        </p>
      </div>
    </div>
  `,
